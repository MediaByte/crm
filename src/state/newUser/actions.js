...
export const homeAddressState = (event) => ({ type: NEW_USER_HOME_ADDRESS_STATE, payload: event });
export const homeAddressZip = (event) => ({ type: NEW_USER_HOME_ADDRESS_ZIP, payload: event });
export const homeAddressCountry = (event) => ({ type: NEW_USER_HOME_ADDRESS_COUNTRY, payload: event });
export const mailAddress1 = (event) => ({ type: NEW_USER_MAIL_ADDRESS1, payload: event });
export const mailAddress2 = (event) => ({ type: NEW_USER_MAIL_ADDRESS2, payload: event });
export const mailAddressCity = (event) => ({ type: NEW_USER_MAIL_ADDRESS_CITY, payload: event });
export const mailAddressState = (event) => ({ type: NEW_USER_MAIL_ADDRESS_STATE, payload: event });
export const mailAddressZip = (event) => ({ type: NEW_USER_MAIL_ADDRESS_ZIP, payload: event });
export const mailAddressCountry = (event) => ({ type: NEW_USER_MAIL_ADDRESS_COUNTRY, payload: event });
export const workAddress1 = (event) => ({ type: NEW_USER_WORK_ADDRESS1, payload: event });
export const workAddress2 = (event) => ({ type: NEW_USER_WORK_ADDRESS2, payload: event });
export const workAddressCity = (event) => ({ type: NEW_USER_WORK_ADDRESS_CITY, payload: event });
